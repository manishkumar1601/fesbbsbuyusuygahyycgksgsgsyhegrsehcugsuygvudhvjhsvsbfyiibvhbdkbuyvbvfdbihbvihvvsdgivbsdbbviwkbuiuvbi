...
Asena.addCommand({pattern: 'ban ?(.*)', fromMe: true, onlyGroup: true, desc: Lang.BAN_DESC, dontAddCommandList: true}, (async (message, match) => {  
    ...
    if (Config.BANMSG == 'default') {
        if (message.reply_message !== false) {
            var blogo = "https://telegra.ph/file/80a88d64fadfd96235d60.png";
            var logoimg = await axios.get(blogo, { responseType: 'arraybuffer' }) 
            await message.client.sendMessage(message.jid,Buffer.from (logoimg.data), MessageType.image, {mimetype: Mimetype.png, caption:'@' + message.reply_message.data.participant.split('@')[0] + '```, ' + Lang.BANNED + '```', contextInfo: {mentionedJid: [message.reply_message.data.participant]}});
            ...
            var blogo = "https://telegra.ph/file/80a88d64fadfd96235d60.png";
            var logoimg = await axios.get(blogo, { responseType: 'arraybuffer' })            
            await message.client.sendMessage(message.jid,Buffer.from (logoimg.data), MessageType.image, {mimetype: Mimetype.png, caption: etiketler + Config.BANMSG, contextInfo: {mentionedJid: message.mention}});
